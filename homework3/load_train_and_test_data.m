...
% 
% load_train_and_test_data: a function that reads training and testing data. 
% The images are flattened out and normalized, labels are converted to one-hot encoded vector.
% Inputs:
%         (None)
% Outputs:
